...
namespace locationiq.Model
{
    ...
    public partial class Location :  IEquatable<Location>, IValidatableObject
    {
        ...
        public Location(string placeId = default(string), string licence = default(string), string osmType = default(string), string osmId = default(string), List<string> boundingbox = default(List<string>), string lat = default(string), string lon = default(string), string displayName = default(string), string _class = default(string), string type = default(string), decimal? importance = default(decimal?), Address address = default(Address), Namedetails namedetails = default(Namedetails))
        {
